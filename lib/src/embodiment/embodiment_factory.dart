...
import 'folder_embodiment.dart' as folder;
import 'folder_item_embodiment.dart' as folder_item;
...
class EmbodimentFactory {
  ...
  List<EmbodimentPackageManifest> collectManifests() {
    ...
    manifests.add(folder.getManifest());
    manifests.add(folder_item.getManifest());
