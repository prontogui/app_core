...
class TextEntryField extends StatefulWidget {
  ...
  /// The fill color for the field. If null then the theme's surfaceContainer
  /// color is used.
  ...
  Widget build(BuildContext context) {
    ...
    Widget buildTextField(OverlayPortalController? controller) {
      ...
      var tf = TextField(
        ...
        maxLines: widget.hideText ? 1 : widget.maxDisplayLines,  // Maintain the assertion: !obscureText || maxLines == 1 inside Flutter
