...
class ServerField extends StatefulWidget {
  const ServerField({super.key, required this.serverAddress, required this.serverPort, required this.onChange});
...
class _ServerFieldState extends State<ServerField> {
  ...
  void initState() {
    super.initState();
    String serverAddressText = widget.serverAddress.isEmpty
        ? ''
        : '${widget.serverAddress}:${widget.serverPort}';
  ...
  Widget _buildTextField(BuildContext context) {
    return TextField(
      ...
      onChanged: (value) {
        ...
        widget.onChange(serverAddress, port);
